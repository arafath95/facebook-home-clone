...
import Man from "../../Assets/Images/storyImg.jpg";
const NavBar = () => {
  return (
    <div className="navbar ">
      {/* for mobile menu */}
      <div className="bg-[#3B5998]  border-gray-200 dark:bg-gray-900 shadow-md p-0 first-line:flex lg:hidden">
      ...
      <nav class="bg-white border-gray-200 dark:bg-gray-900 shadow-md lg:fixed  top-20 lg:top-0  w-full lg:w-full h-[80px] z-50 py-2">
        ...
        <div class="flex  justify-between items-center  max-w-screen-full  py-2.5">
          ...
          {/* searcbar for destop */}
          <div className=" hidden lg:flex items-center bg-gray-100  max-w-sm md:max-w-md lg:w-1/2 py-2 hover:bg-gray-200 rounded-[30px] ">
          ...
          <div class="flex  items-end  mx-auto md:mx-auto  gap-8 md:gap-8 lg:mx-0 lg:gap-3 pr-4">
            ...
            {/* for destop icon  */}
            <div className="hidden lg:flex topbarIconItem bg-gray-200 hover:bg-gray-300 p-2 rounded-full w-10 h-10 flex items-center justify-center">
              <BsMessenger className=" text-lg " />
            </div>
            ...
            <div
              ...
              className="hidden lg:flex topbarIconItem bg-gray-200 hover:bg-gray-300 p-2 rounded-full w-10 h-10 flex items-center justify-center"
            ></div>
          </div>
        </div>
      </nav>
