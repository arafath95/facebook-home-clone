...
import Smith from "../../Assets/Images/storyImg.jpg";
      ...
      <div className="">
        <div className=" mx-auto max-w-sm md:max-w-md lg:max-w-[750px] bg-white shadow-md rounded-xl mb-4 ">
          ...
          <div className="likeCommentShar mb- ">
            <div className="flex justify-between p-2 pb-4 border-b-2 mx-4">
              {/* imoje */}
            ...
            <div className=" flex justify-between p-4 px-8 mx-8 pb-4 ">
              <div
